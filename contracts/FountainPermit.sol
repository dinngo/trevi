 ...
 */
contract FountainPermit is Fountain {
    ...
    modifier canHarvestFrom(address owner) {
        require(
            ...
            "FountainPermit: harvest not allowed"
        );
        _;
    }
    ...
    ) public Fountain(token, name_, symbol_) {}
    ...
    function harvestPermit(
        ...
        require(
            ...
            "FountainPermit: expired deadline"
        );
        ...
        require(signer == owner, "FountainPermit: invalid signature");
    ...
    function _harvestApprove(
        ...
        require(
            owner != address(0),
            "FountainPermit: approve from the zero address"
        );
        require(
            sender != address(0),
            "FountainPermit: approve to the zero address"
        );
